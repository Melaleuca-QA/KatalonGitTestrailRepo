...
WebUI.setText(findTestObject('OB001/Page_/input_ Email  _UserName (16)'), GlobalVariable.tw_input_username2)

WebUI.setEncryptedText(findTestObject('OB001/Page_/input__Password (16)'), GlobalVariable.tw_input_password2)
