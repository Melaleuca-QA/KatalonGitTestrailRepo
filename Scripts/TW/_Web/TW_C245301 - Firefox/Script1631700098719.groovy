...
WebUI.setText(findTestObject('OB001/Page_/input_ Email  _UserName (1)'), GlobalVariable.tw_input_username1)

WebUI.setEncryptedText(findTestObject('OB001/Page_/input__Password (1)'), GlobalVariable.tw_input_password1)
...
WebUI.click(findTestObject('OB001/Page_/div_ (1)'))
