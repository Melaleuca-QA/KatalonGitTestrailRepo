...
if (GlobalVariable.test_case2 != '') {
    request = (((('{"results":[{"case_id":' + cases) + ',"status_id":1,"assignedto_id":78, "comment":"Katalon-TW"}, {"case_id":') + 
    cases2) + ',"status_id":1, "assignedto_id":78, "comment":"Katalon-TW"}]}')
} else {
    request = (('{"results":[{"case_id":' + cases) + ',"status_id":1,"assignedto_id":78, "comment":"Katalon-TW"}]}')
}
println request
