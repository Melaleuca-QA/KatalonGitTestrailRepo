...
WebUI.click(findTestObject('Object Repository/_OB_Jill/Page_Shopping Cart/span_add'))
...
WebUI.setText(findTestObject('Object Repository/_OB_Jill/Page_Add New Payment Method/input_Card Number_cardNumber'), GlobalVariable.sg_input_creditcard)
