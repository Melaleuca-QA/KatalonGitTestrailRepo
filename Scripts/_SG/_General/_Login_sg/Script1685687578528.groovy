...
WebUI.setText(findTestObject('OB_NSE/Page_/input__username'), GlobalVariable.sg_username1)

WebUI.setEncryptedText(findTestObject('OB_NSE/Page_/input__password'), GlobalVariable.sg_password1)
