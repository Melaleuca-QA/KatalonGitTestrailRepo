...
WebUI.click(findTestObject('OB_NSE/Page_/a_BusinessCenter_enroll_tw'))

'FollowUpCenter'
WebUI.click(findTestObject('OB_NSE/Page_/a_FollowUpCenter'))
...
'組織轉換'
WebUI.click(findTestObject('OB_NSE/Page_/a_OrgChange'))
...
WebUI.click(findTestObject('OB_NSE/Page_/a_Logout_tw_2'))
...
WebUI.setEncryptedText(findTestObject('OB_NSE/Page_/input_password'), GlobalVariable.nse_tw_password1)

WebUI.click(findTestObject('OB_NSE/Page_/button_Login'))

WebUI.waitForAlert(5)

'back to legacy Business Center Page'
WebUI.click(findTestObject('OB_NSE/Page_Welcome to Melaleuca, The Wellness Company/a_business center'))
...
'back to legacy env  Business Center Page'
WebUI.click(findTestObject('OB_NSE/Page_Welcome to Melaleuca, The Wellness Company/a_business center'))
...
WebUI.callTestCase(findTestCase('_TW/_NSE/_General/_Logout_tw-Legacy'), [:], FailureHandling.STOP_ON_FAILURE)
