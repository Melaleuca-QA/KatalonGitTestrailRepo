...
WebUI.setText(findTestObject('OB_NSE/Page_/input_username'), GlobalVariable.tw_input_username2)

WebUI.setEncryptedText(findTestObject('OB_NSE/Page_/input_password'), GlobalVariable.tw_input_password2)
