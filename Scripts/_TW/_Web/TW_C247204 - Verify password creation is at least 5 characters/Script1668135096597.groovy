...
result1 = WebUI.getText(findTestObject('OB001/Page_/span_BusinessCenter_OLE_PCInfo'))
...
result1 = WebUI.getText(findTestObject('OB001/Page_/label_BusinessCenter_OLE_DCChkAgree1'))
...
WebUI.click(findTestObject('OB001/Page_/label_BusinessCenter_OLE_DCChkAgree1'))
...
WebUI.click(findTestObject('OB001/Page_/span_MyAccount_SetupPaymethod_Edit'))
