...
WebUI.focus(findTestObject('OB_Web/Page_/button_Checkout_ChangeAddress'))
...
WebUI.setText(findTestObject('OB_Web/Page_/input_AddressToEdit.AddressLine1'), 'testaddress5')

WebUI.setText(findTestObject('OB_Web/Page_/input_AddressToEdit.AddressLine2'), 'testaddress6')
