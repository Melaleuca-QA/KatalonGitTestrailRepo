...
WebUI.navigateToUrl(GlobalVariable.url_uatjp)
...
WebUI.setText(findTestObject('OB_NSE/Page_/input__username'), GlobalVariable.jp_username1)

WebUI.setEncryptedText(findTestObject('OB_NSE/Page_/input__password'), GlobalVariable.jp_password1)
