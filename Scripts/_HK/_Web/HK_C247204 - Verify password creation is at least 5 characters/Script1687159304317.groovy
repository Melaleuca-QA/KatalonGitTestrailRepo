...
WebUI.click(findTestObject('OB_Web/Page_Melaleuca The Wellness Company/label_BusinessCenter_OLE_Presenter_ChkAgree'))

WebUI.click(findTestObject('OB_Web/Page_Melaleuca The Wellness Company/label_BusinessCenter_OLE_NewEnroll_ChkAgree'))
...
result1 = WebUI.getText(findTestObject('OB_Web/Page_/p_HK250.0'))
...
result1 = WebUI.getText(findTestObject('OB_Web/Page_/label_BusinessCenter_OLE_NewEnroll_ChkAgree'))
...
WebUI.setText(findTestObject('OB_Web/Page_/input_PaymethodViewModel'), GlobalVariable.hk_input_newname)
...
WebUI.click(findTestObject('OB_Web/Page_/label_BusinessCenter_OLE_NewEnroll_ChkAgree'))
...
WebUI.click(findTestObject('Object Repository/OB_Web/Page_/button_BusinessCenter_OLE_IMEA_Start'))
...
WebUI.click(findTestObject('OB_Web/Page_/label_BusinessCenter_OLE_IMEA_ParticipationLevel'))
...
WebUI.click(findTestObject('OB_Web/Page_Melaleuca The Wellness Company/span_MyAccount_SetupPaymethod_Edit'))
...
WebUI.click(findTestObject('OB_Web/Page_Melaleuca The Wellness Company/button_MyAccount_SetupPaymethod_save'))
