...
WebUI.setText(findTestObject('OB001/Page_/input_ Email  _UserName (10)'), GlobalVariable.input_username)

WebUI.setEncryptedText(findTestObject('OB001/Page_/input__Password (10)'), GlobalVariable.input_password)
