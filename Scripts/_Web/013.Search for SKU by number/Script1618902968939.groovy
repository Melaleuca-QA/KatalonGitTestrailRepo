...
WebUI.click(findTestObject('Object Repository/Page_/input_ Email  _UserName (10)'))

WebUI.setText(findTestObject('Object Repository/Page_/input_ Email  _UserName (10)'), 'tw1')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_/input__Password (10)'), '8SQVv/p9jVScEs4/2CZsLw==')

WebUI.click(findTestObject('Object Repository/Page_/button_ (12)'))
...
WebUI.setText(findTestObject('Object Repository/Page_Melaleuca The Wellness Company/input__js-search-input'), 'lemon')
