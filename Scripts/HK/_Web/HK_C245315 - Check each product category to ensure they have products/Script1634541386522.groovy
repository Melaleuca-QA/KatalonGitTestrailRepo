...
WebUI.click(findTestObject('OB003/Page_Melaleuca The Wellness Company/span_fa fa-shopping-cart'))
...
WebUI.click(findTestObject('OB003/Page_Melaleuca The Wellness Company/button_promotion_add'))
